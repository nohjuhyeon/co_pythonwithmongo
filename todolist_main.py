...
collection_todos = todolist_functions.Connect_Mongo("todos_list")          # hint           collection_todo -> collection_todos 로 변경
...
todolist_functions.Data_insert(collection_todos, todo_list)         # hint          update -> insert로 변경
